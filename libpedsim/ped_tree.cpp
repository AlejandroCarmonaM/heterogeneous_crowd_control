...
/// \author  chgloor
/// \date    2012-01-28
Ped::Ttree::Ttree(Ped::Ttree* root, std::map<const Ped::Tagent*, Ped::Ttree*>* treehash, int pdepth,
                  int pmaxDepth, int px, int py, int pw, int ph) {
...
/// left, they are removed first (not deleted). \author  chgloor \date
/// 2012-01-28
...
Ped::Ttree* Ped::Ttree::getChildByPosition(int xIn, int yIn) {
...
bool Ped::Ttree::intersects(int px, int py, int pr) const {
